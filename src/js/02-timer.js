...
const getBtnStartEl = document.querySelector('button[data-start]');
const dateDays = document.querySelector('.value[data-days]');
const dateHours = document.querySelector('.value[data-hours]');
const dateMin = document.querySelector('.value[data-minutes]');
const dateSec = document.querySelector('.value[data-seconds]');
const counterClass = document.querySelector('.timer');
counterClass.classList.add('Flexstyle');
